...
class WikiRacerTest(unittest.TestCase):
    ...
    def test_5(self):
        ...
        self.assertTrue(path == ['Дружина (військо)', 'Велике князівство Московське',
                                 '22 жовтня', '6 жовтня'] or path == [
            'Дружина (військо)', 'Збройні сили Австро-Угорщини', '22 жовтня', '6 жовтня'])
